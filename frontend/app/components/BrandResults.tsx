...
export const BrandResults = ({
  ...
  const generatePPTX = async () => {
    ...
    // Add logo
    if (currentLogo) {
      const logoDataUrl = createSvgDataUrl(currentLogo);
      slide1.addImage({
        data: logoDataUrl,
        x: "30%",
        y: "20%",
    ...
    slide1.addText("Brand Guidelines", {
      x: 0,
      y: "70%",
      w: "100%",
      h: 1,
    ...
    const typographyExamples = [
      { text: "Heading 1", size: 36, bold: true },
      { text: "Heading 2", size: 28, bold: true },
      { text: "Heading 3", size: 24, bold: true },
      { text: FONT_SHOWCASE_TEXT, size: 18, bold: false },
    ];

    typographyExamples.forEach((example, idx) => {
      slide2.addText(example.text, {
        x: 0.5,
        y: 0.4 + idx * 0.15,
        w: "90%",
    ...
    slide3.addText(
      [
        ...
        { text: `HEX: #${colors[selectedColor]}\n`, options: { fontSize: 16 } },
        {
          text: `RGB: ${hexToRgb(`#${colors[selectedColor]}`)}\n`,
          options: { fontSize: 16 },
        },
        {
          text: `HSL: ${hexToHsl(`#${colors[selectedColor]}`)}`,
          options: { fontSize: 16 },
        },
      ],
      {
    ...
    const variations = [0.8, 0.6, 0.4, 0.2];
    variations.forEach((opacity, idx) => {
      slide3.addShape(pres.ShapeType.rect, {
        x: 0.5 + idx * 1.5,
        y: 3,
        w: 1,
    ...
    pres.writeFile(`${companyName.toLowerCase()}-brand-guidelines.pptx`);
  };
